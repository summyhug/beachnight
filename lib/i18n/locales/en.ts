...
export const en: Dict = {
  ...
  hero: {
    ...
    noWithout: (region, beach, _deTickerLead) => `No ${region} without ${beach}.`,
  },
  home: {
    ...
    whenDateTbd: "Date to be announced",
    whenTimeLabel: "Right before sunset",
    whenTimeNote:
  ...
  about: {
    ...
    participate2BeforeLink:
      "When will this be? Once there is a date for Beachnight, it will be published here a few weeks in advance. You can also ",
    participate2LinkText: "sign up here",
    participate2AfterLink: " and you’ll be notified proactively.",
    participate3:
  ...
  join: {
    ...
    success: "Thank you — you're registered. We'll be in touch at the email you provided.",
    fullName: "Full name",
    email: "Email",
    beach: "Your Beach",
  ...
  footer: {
    ...
    updatesBlurb: "No mailing list. Use the {join} — that’s the only way we’ll send updates.",
    updatesLinkLabel: "Join page",
    shareTitle: "Share the night",
    shareText: "When you post photos or video, use #{tag1} and #{tag2} so we can find your story.",
    aiVideoNote: "The event preview video was made with AI to imagine what Beachnight could look like.",
  },
};
